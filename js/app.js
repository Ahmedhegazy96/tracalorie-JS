class CalorieTracker {
  constructor() {
    ...
    this._displayCaloriesLimit();  // Display initial calorie limit and total calories.
  ...
  addMeal(meal) {
    ...
    Storage.updateLocalStorage(this._totalCalories)
...
class App {
  ...
  _filterItems(type, e) {
    ...
    document.querySelectorAll(`#${type}-items .card`).forEach(item => {
      const name = item.firstElementChild.firstChild.textContent;
